module "stack" {
  ...
  mcp_client_container_image            = "${local.ecr_mcp_client_repo_url}:v1.13.2-70bd7da4712ea64e5fb160e2cc457f1ae37dc431"
  mcp_server_container_image            = "${local.ecr_mcp_server_repo_url}:v1.13.2-70bd7da4712ea64e5fb160e2cc457f1ae37dc431"
  ...
  dashboard_container_image             = "${local.ecr_dashboard_repo_url}:v1.13.2-70bd7da4712ea64e5fb160e2cc457f1ae37dc431"
