        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "token_url",
                    models.URLField(
                        help_text="URL of the OAuth token endpoint, e.g. https://auth.wellcomecollection.org/oauth2/token",
                        max_length=256,
                    ),
                ),
                (
                    "api_root_url",
                    models.URLField(
                        help_text="Root URL of the storage service API, e.g. https://api.wellcomecollection.org/",
                        max_length=256,
                    ),
                ),
                (
                ...
                (
                    "aws_assumed_role",
                    models.CharField(
                        max_length=256, verbose_name="Assumed AWS IAM Role", blank=True
                    ),
                ),
                (
                    "s3_region",
                ...
                (
                    "s3_bucket",
                    models.CharField(
                        help_text="S3 Bucket for temporary storage",
                        max_length=64,
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                choices=[
                    ...
                    (b"SWIFT", "Swift"),
                    (b"S3", "S3"),
                    (b"WELLCOME", "Wellcome Storage Service"),
                ],
            ),
        ),
        migrations.AddField(
